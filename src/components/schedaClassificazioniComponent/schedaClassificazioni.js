...
export default class SchedaClassificazioni extends Component {
    ...
    render() {
        return (
            ...
            <div className="u-background-grey-10 u-color-grey-50 u-padding-all-l u-margin-bottom-l" id="Section-Classificazioni">
                <div className="Grid">
                    <div className="Grid-cell u-md-size5of6 u-lg-size5of6 u-padding-right-xl">
                    <h3 class="u-color-80 u-text-h4">{/*<span class="icon-tag icons u-text-xs"></span>*/} Classificazioni</h3>
                    </div>
